        ...
        <div class="col-xl-7 col-m-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3" style="background-color: #263A56">
                    <h6 class="m-0 font-weight-bold" style="color: white">UPDATE STATUS</h6>
                </div>
                <div class="card-body">
                    <?php foreach($statusdata as $statusd): ?>
                    <?= form_open('status/edit/'.$statusd['stid'], ['class' => 'user']); ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                ...
                                name="iptdescription" placeholder="Description" style="color: black;"><?= $statusd['description']; ?></textarea>
                            </div>
                        </div>
                </div>
