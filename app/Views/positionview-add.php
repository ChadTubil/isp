        ...
        <div class="col-xl-7 col-m-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3" style="background-color: #263A56">
                    <h6 class="m-0 font-weight-bold" style="color: white">ADD POSITION</h6>
                </div>
                <div class="card-body">
                    <?= form_open('position/add', ['class' => 'user']); ?>
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <label class="custom-label" for="username" style="color: black;">POSITION</label>
                                <input type="text" class="form-control form-control-user"
                                    name="iptposition" placeholder="Position" style="color: black;">
                            </div>
                            <div class="col-sm-12">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-danger btn-icon-split" title="Cancel"
                        onclick="window.location.href='<?= base_url(); ?>position'">
