...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #263A56">
            <!-- Sidebar - Brand -->
            <li class="nav-item active">
                <a class="sidebar-brand align-items-center justify-content-center" href="<?= base_url() ?>dashboard">
                    <div class="sidebar-brand-icon">
                        <img style="width: 70%" src="<?= base_url(); ?>public/assets/Logo2.png" alt="Logo" class="logo">
            ...
            <li class="nav-item">
                ...
                <div id="setup" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>plans">Plans</a>
                        <a class="collapse-item" href="<?= base_url() ?>inclusions">Inclusions</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column" >
            ...
            <div id="content">
                <!-- Topbar -->
                <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="background-color: #263A56">
                    ...
                    <ul class="navbar-nav ml-auto" >
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline small" style="color: white;"><?= $userdata->username; ?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0" style="color: black"><strong><?php $this->renderSection("heading"); ?></strong></h1>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <strong style="color: black;"><span>Copyright &copy; ISP 2024</span></strong>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
