        ...
        <div class="card-body">
            ...
            <div class="table-responsive" style="color: black;">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="color: black;">
                    ...
                    <tbody>
                        <?php foreach($resultClient as $resultC): ?>
                            <tr>
                                <td><?= $resultC['clientid']; ?></td>
                                <td><?= $resultC['fullname']; ?></td>
                                <td></td>
                                <td></td>
                                <td style="text-align: center;">
                                    <button class="btn btn-info btn-sm" title="Edit"
                                    onclick="window.location.href='<?= base_url(); ?>clients/edit/<?= $resultC['clientid']; ?>'">
                                        <i class="fas fa-fw fa-pen"></i>
                                    </button>
                                    <button class="btn btn-danger btn-sm" title="Delete"
                                        onclick="window.location.href='<?= base_url(); ?>clients/delete/<?= $resultC['clientid']; ?>'">
