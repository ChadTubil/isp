        ...
        <div class="col-xl-12 col-m-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3" style="background-color: #263A56">
                    <h6 class="m-0 font-weight-bold" style="color: white">UPDATE EMPLOYEE</h6>
                </div>
                <div class="card-body">
                    <?php foreach($employeesdata as $employeesd): ?>
                    <?= form_open('employees/edit/'.$employeesd['empid'], ['class' => 'user']); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5 mb-12 mb-sm-0">
                                ...
                                <select name="iptposition" class="form-control"
                                    style="color: black;">
                                    <option value="<?= $employeesd['position']; ?>" selected>
